...
?>
<?php echo file_get_contents("valettoplevelmainnavbar.html"); ?>
<?php echo file_get_contents("valetincomingcar.html"); ?>
...
$floor_id = 1;
    ...
    $insert_stmt->bind_param("sss", $entry_time, $license_plate, $floor_id);

        if($insert_stmt->execute()) {
            echo "Successfully Registered new car !";
            echo "<script>
                setTimeout(function(){
                    window.location.href = 'valetincomingcar.php';
