...
<?php echo file_get_contents("viewoccupency.html"); ?>
...
$sql = "SELECT NUMBER_OF_BLOCKS FROM parking_lot"; // your SQL query 
$result = $link->query($sql); 
 
if ($result->num_rows > 0) { 
    // Output data of each row 
    echo "<table><tr><th>Total Spaces Available</th></tr>"; // Adjust headers as needed 
...
if ($result->num_rows > 0) { 
    // Output data of each row 
    echo "<table><tr><th>Total Spaces on Floor 1 </th></tr>"; // Adjust headers as needed 
    while($row = $result->fetch_assoc()) { 
        echo "<tr><td>" . $row["NUMBER_OF_BLOCKS"] . "</td></tr>"; // Adjust according to your columns 
    } 
    echo "</table>"; 
